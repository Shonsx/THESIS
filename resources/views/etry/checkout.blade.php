            ...
            <div class="flex flex-col lg:flex-row gap-4">
                ...
                <div class="w-full lg:w-1/2">
                    @if(isset($product))
                        ...
                        <img src="{{ asset('images/' . $product->image) }}" alt="{{ $product->name }}" class="w-full sm:w-[180px] h-auto object-cover rounded">
                    ...
                    @elseif(isset($cartItems) && count($cartItems) > 0)
                        ...
                        <div class="bg-white rounded-lg shadow-lg p-4 flex flex-col sm:flex-row items-center mb-4">
                        <img src="{{ asset('images/' . $item->product->image) }}" alt="{{ $item->product->name }}" class="w-full sm:w-[180px] h-auto object-cover rounded">
                            <div class="sm:ml-4 mt-4 sm:mt-0 flex-grow w-full">
                ...
                <div class="w-full lg:w-1/2 flex flex-col gap-4">
                    ...
                    <div class="bg-white rounded-lg shadow-lg p-4">
                        ...
                        @if(isset($gcash) && $gcash->image_path && file_exists(public_path('images/' . $gcash->image_path)))
                            <img src="{{ asset('images/' . $gcash->image_path) }}" alt="GCash QR" class="w-full max-h-[300px] object-contain mb-2" />
                        @else
