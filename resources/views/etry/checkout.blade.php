            ...
            <div class="flex flex-col lg:flex-row gap-4">
                ...
                <div class="w-full lg:w-1/2">
                    @if(isset($product))
                        ...
                        <img src="{{ route('files.public', ['path' => $product->image]) }}" alt="{{ $product->name }}" class="w-full sm:w-[180px] h-auto object-cover rounded">
                    ...
                    @elseif(isset($cartItems) && count($cartItems) > 0)
                        ...
                        <div class="bg-white rounded-lg shadow-lg p-4 flex flex-col sm:flex-row items-center mb-4">
                        <img src="{{ route('files.public', ['path' => $item->product->image]) }}" alt="{{ $item->product->name }}" class="w-full sm:w-[180px] h-auto object-cover rounded">
                            <div class="sm:ml-4 mt-4 sm:mt-0 flex-grow w-full">
